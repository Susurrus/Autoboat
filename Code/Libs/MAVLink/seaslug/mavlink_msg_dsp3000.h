...
#if MAVLINK_MSG_ID_DSP3000_LEN <= MAVLINK_MAX_PAYLOAD_LEN
/*
 ...
 */
static inline void mavlink_msg_dsp3000_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float z_rate)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#endif
#else
	mavlink_dsp3000_t *packet = (mavlink_dsp3000_t *)msgbuf;
	packet->z_rate = z_rate;
