...
#define MAVLINK_MSG_ID_CONTROLLER_DATA_LEN 66
#define MAVLINK_MSG_ID_180_LEN 66

#define MAVLINK_MSG_ID_CONTROLLER_DATA_CRC 164
#define MAVLINK_MSG_ID_180_CRC 164
...
#define MAVLINK_MESSAGE_INFO_CONTROLLER_DATA { \
	...
	{  { "lat", NULL, MAVLINK_TYPE_INT32_T, 0, 0, offsetof(mavlink_controller_data_t, lat) }, \
         ...
         { "north_speed", NULL, MAVLINK_TYPE_INT16_T, 0, 46, offsetof(mavlink_controller_data_t, north_speed) }, \
         { "east_speed", NULL, MAVLINK_TYPE_INT16_T, 0, 48, offsetof(mavlink_controller_data_t, east_speed) }, \
         { "a_cmd", NULL, MAVLINK_TYPE_INT16_T, 0, 50, offsetof(mavlink_controller_data_t, a_cmd) }, \
         { "aim_point_n", NULL, MAVLINK_TYPE_INT16_T, 0, 52, offsetof(mavlink_controller_data_t, aim_point_n) }, \
         { "aim_point_e", NULL, MAVLINK_TYPE_INT16_T, 0, 54, offsetof(mavlink_controller_data_t, aim_point_e) }, \
         { "commanded_rudder_angle", NULL, MAVLINK_TYPE_INT16_T, 0, 56, offsetof(mavlink_controller_data_t, commanded_rudder_angle) }, \
         { "commanded_throttle", NULL, MAVLINK_TYPE_INT16_T, 0, 58, offsetof(mavlink_controller_data_t, commanded_throttle) }, \
         { "rudder_angle", NULL, MAVLINK_TYPE_INT16_T, 0, 60, offsetof(mavlink_controller_data_t, rudder_angle) }, \
         { "prop_speed", NULL, MAVLINK_TYPE_INT16_T, 0, 62, offsetof(mavlink_controller_data_t, prop_speed) }, \
         { "new_gps_fix", NULL, MAVLINK_TYPE_UINT8_T, 0, 64, offsetof(mavlink_controller_data_t, new_gps_fix) }, \
         { "reset", NULL, MAVLINK_TYPE_UINT8_T, 0, 65, offsetof(mavlink_controller_data_t, reset) }, \
         } \
}
						       ...
						       int16_t last_wp_north, int16_t last_wp_east, int16_t next_wp_north, int16_t next_wp_east, int16_t yaw, int16_t pitch, int16_t roll, int16_t x_angle_vel, int16_t y_angle_vel, int16_t z_angle_vel, uint16_t water_speed, uint8_t new_gps_fix, int32_t lat, int32_t lon, uint16_t sog, uint16_t cog, uint8_t reset, uint32_t time_boot_ms, int32_t north, int32_t east, int16_t north_speed, int16_t east_speed, int16_t a_cmd, int16_t aim_point_n, int16_t aim_point_e, int16_t commanded_rudder_angle, int16_t commanded_throttle, int16_t rudder_angle, int16_t prop_speed)
{
	...
	_mav_put_int16_t(buf, 46, north_speed);
	_mav_put_int16_t(buf, 48, east_speed);
	_mav_put_int16_t(buf, 50, a_cmd);
	_mav_put_int16_t(buf, 52, aim_point_n);
	_mav_put_int16_t(buf, 54, aim_point_e);
	_mav_put_int16_t(buf, 56, commanded_rudder_angle);
	_mav_put_int16_t(buf, 58, commanded_throttle);
	_mav_put_int16_t(buf, 60, rudder_angle);
	_mav_put_int16_t(buf, 62, prop_speed);
	_mav_put_uint8_t(buf, 64, new_gps_fix);
	_mav_put_uint8_t(buf, 65, reset);
...
{
	return mavlink_msg_controller_data_pack(system_id, component_id, msg, controller_data->last_wp_north, controller_data->last_wp_east, controller_data->next_wp_north, controller_data->next_wp_east, controller_data->yaw, controller_data->pitch, controller_data->roll, controller_data->x_angle_vel, controller_data->y_angle_vel, controller_data->z_angle_vel, controller_data->water_speed, controller_data->new_gps_fix, controller_data->lat, controller_data->lon, controller_data->sog, controller_data->cog, controller_data->reset, controller_data->time_boot_ms, controller_data->north, controller_data->east, controller_data->north_speed, controller_data->east_speed, controller_data->a_cmd, controller_data->aim_point_n, controller_data->aim_point_e, controller_data->commanded_rudder_angle, controller_data->commanded_throttle, controller_data->rudder_angle, controller_data->prop_speed);
}
