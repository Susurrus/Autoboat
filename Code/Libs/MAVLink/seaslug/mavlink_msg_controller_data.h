...
typedef struct __mavlink_controller_data_t
{
 ...
 int16_t x_accel; ///< Acceleration along the X-axis. (m/s^2 * 2^8)
 int16_t y_accel; ///< Acceleration along the Y-axis. (m/s^2 * 2^8)
 int16_t z_accel; ///< Acceleration along the Z-axis. (m/s^2 * 2^8)
...
#define MAVLINK_MESSAGE_INFO_CONTROLLER_DATA { \
	...
	{  { "lat", NULL, MAVLINK_TYPE_INT32_T, 0, 0, offsetof(mavlink_controller_data_t, lat) }, \
         ...
         { "x_accel", NULL, MAVLINK_TYPE_INT16_T, 0, 40, offsetof(mavlink_controller_data_t, x_accel) }, \
         { "y_accel", NULL, MAVLINK_TYPE_INT16_T, 0, 42, offsetof(mavlink_controller_data_t, y_accel) }, \
         { "z_accel", NULL, MAVLINK_TYPE_INT16_T, 0, 44, offsetof(mavlink_controller_data_t, z_accel) }, \
         { "water_speed", NULL, MAVLINK_TYPE_UINT16_T, 0, 46, offsetof(mavlink_controller_data_t, water_speed) }, \
         { "sog", NULL, MAVLINK_TYPE_UINT16_T, 0, 48, offsetof(mavlink_controller_data_t, sog) }, \
         { "cog", NULL, MAVLINK_TYPE_UINT16_T, 0, 50, offsetof(mavlink_controller_data_t, cog) }, \
         { "hdop", NULL, MAVLINK_TYPE_UINT16_T, 0, 52, offsetof(mavlink_controller_data_t, hdop) }, \
         { "north_speed", NULL, MAVLINK_TYPE_INT16_T, 0, 54, offsetof(mavlink_controller_data_t, north_speed) }, \
         { "east_speed", NULL, MAVLINK_TYPE_INT16_T, 0, 56, offsetof(mavlink_controller_data_t, east_speed) }, \
         { "a_cmd", NULL, MAVLINK_TYPE_INT16_T, 0, 58, offsetof(mavlink_controller_data_t, a_cmd) }, \
         { "aim_point_n", NULL, MAVLINK_TYPE_INT16_T, 0, 60, offsetof(mavlink_controller_data_t, aim_point_n) }, \
         { "aim_point_e", NULL, MAVLINK_TYPE_INT16_T, 0, 62, offsetof(mavlink_controller_data_t, aim_point_e) }, \
 ...
 * @param x_accel Acceleration along the X-axis. (m/s^2 * 2^8)
 * @param y_accel Acceleration along the Y-axis. (m/s^2 * 2^8)
 * @param z_accel Acceleration along the Z-axis. (m/s^2 * 2^8)
						       ...
						       int16_t last_wp_north, int16_t last_wp_east, int16_t next_wp_north, int16_t next_wp_east, int16_t yaw, int16_t pitch, int16_t roll, int16_t x_angle_vel, int16_t y_angle_vel, int16_t z_angle_vel, int16_t x_accel, int16_t y_accel, int16_t z_accel, uint16_t water_speed, uint8_t new_gps_fix, int32_t lat, int32_t lon, uint16_t sog, uint16_t cog, uint16_t hdop, uint8_t reset, uint32_t time_boot_ms, int32_t north, int32_t east, int16_t north_speed, int16_t east_speed, int16_t a_cmd, int16_t aim_point_n, int16_t aim_point_e, int16_t yaw_rate, int16_t commanded_rudder_angle, int16_t commanded_throttle, int16_t rudder_angle, int16_t prop_speed)
{
	...
	_mav_put_int16_t(buf, 40, x_accel);
	_mav_put_int16_t(buf, 42, y_accel);
	_mav_put_int16_t(buf, 44, z_accel);
	_mav_put_uint16_t(buf, 46, water_speed);
	_mav_put_uint16_t(buf, 48, sog);
	_mav_put_uint16_t(buf, 50, cog);
	_mav_put_uint16_t(buf, 52, hdop);
	_mav_put_int16_t(buf, 54, north_speed);
	_mav_put_int16_t(buf, 56, east_speed);
	_mav_put_int16_t(buf, 58, a_cmd);
	_mav_put_int16_t(buf, 60, aim_point_n);
	_mav_put_int16_t(buf, 62, aim_point_e);
...
/**
 * @brief Get field x_accel from controller_data message
 *
 * @return Acceleration along the X-axis. (m/s^2 * 2^8)
 */
static inline int16_t mavlink_msg_controller_data_get_x_accel(const mavlink_message_t* msg)
{
	return _MAV_RETURN_int16_t(msg,  40);
}

/**
 * @brief Get field y_accel from controller_data message
 *
 * @return Acceleration along the Y-axis. (m/s^2 * 2^8)
 */
static inline int16_t mavlink_msg_controller_data_get_y_accel(const mavlink_message_t* msg)
{
	return _MAV_RETURN_int16_t(msg,  42);
}

/**
 * @brief Get field z_accel from controller_data message
 *
 * @return Acceleration along the Z-axis. (m/s^2 * 2^8)
 */
static inline int16_t mavlink_msg_controller_data_get_z_accel(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_controller_data_decode(const mavlink_message_t* msg, mavlink_controller_data_t* controller_data)
{
	...
	controller_data->x_accel = mavlink_msg_controller_data_get_x_accel(msg);
	controller_data->y_accel = mavlink_msg_controller_data_get_y_accel(msg);
	controller_data->z_accel = mavlink_msg_controller_data_get_z_accel(msg);
