...
typedef struct __mavlink_sys_status_t
{
 ...
 uint32_t onboard_control_sensors_healthy; ///< Bitmask showing which onboard controllers and sensors are operational or have an error:  Value of 0: sensor is in error, value of 1: sensor is healthy. Indices: 0: 3D gyro, 1: 3D acc, 2: 3D mag, 3: absolute pressure, 4: differential pressure, 5: GPS, 6: optical flow, 7: computer vision position, 8: laser based position, 9: external ground-truth (Vicon or Leica). Controllers: 10: 3D angular rate control 11: attitude stabilization, 12: yaw position, 13: z/altitude control, 14: x/y position control, 15: motor outputs / control, 16: RC receiver
...
#define MAVLINK_MSG_ID_SYS_STATUS_CRC 125
...
#define MAVLINK_MESSAGE_INFO_SYS_STATUS { \
	...
	{  { "onboard_control_sensors_present", "0x%04x", MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_sys_status_t, onboard_control_sensors_present) }, \
         ...
         { "onboard_control_sensors_healthy", "0x%04x", MAVLINK_TYPE_UINT32_T, 0, 8, offsetof(mavlink_sys_status_t, onboard_control_sensors_healthy) }, \
 ...
 * @param onboard_control_sensors_healthy Bitmask showing which onboard controllers and sensors are operational or have an error:  Value of 0: sensor is in error, value of 1: sensor is healthy. Indices: 0: 3D gyro, 1: 3D acc, 2: 3D mag, 3: absolute pressure, 4: differential pressure, 5: GPS, 6: optical flow, 7: computer vision position, 8: laser based position, 9: external ground-truth (Vicon or Leica). Controllers: 10: 3D angular rate control 11: attitude stabilization, 12: yaw position, 13: z/altitude control, 14: x/y position control, 15: motor outputs / control, 16: RC receiver
...
static inline uint16_t mavlink_msg_sys_status_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint32_t onboard_control_sensors_present, uint32_t onboard_control_sensors_enabled, uint32_t onboard_control_sensors_healthy, uint16_t load, uint16_t voltage_battery, int16_t current_battery, int8_t battery_remaining, uint16_t drop_rate_comm, uint16_t errors_comm, uint16_t errors_count1, uint16_t errors_count2, uint16_t errors_count3, uint16_t errors_count4)
{
	...
	_mav_put_uint32_t(buf, 8, onboard_control_sensors_healthy);
	...
	packet.onboard_control_sensors_healthy = onboard_control_sensors_healthy;
	packet.load = load;
...
/**
 * @brief Get field onboard_control_sensors_healthy from sys_status message
 *
 * @return Bitmask showing which onboard controllers and sensors are operational or have an error:  Value of 0: sensor is in error, value of 1: sensor is healthy. Indices: 0: 3D gyro, 1: 3D acc, 2: 3D mag, 3: absolute pressure, 4: differential pressure, 5: GPS, 6: optical flow, 7: computer vision position, 8: laser based position, 9: external ground-truth (Vicon or Leica). Controllers: 10: 3D angular rate control 11: attitude stabilization, 12: yaw position, 13: z/altitude control, 14: x/y position control, 15: motor outputs / control, 16: RC receiver
 */
static inline uint32_t mavlink_msg_sys_status_get_onboard_control_sensors_healthy(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_sys_status_decode(const mavlink_message_t* msg, mavlink_sys_status_t* sys_status)
{
	...
	sys_status->onboard_control_sensors_healthy = mavlink_msg_sys_status_get_onboard_control_sensors_healthy(msg);
