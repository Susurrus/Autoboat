...
TStar.Description = 'Distance from the 1st waypoint that the initial point should be set to. Only relevant if InitialPoint is True.';
IPStar.Value = 0;
...
TStar.Description = 'Indicates whether the initial-point logic will be used';
...
TStar.Description = 'Indicates to turn towards L2 vector versus away from it.';
Turn2Track.Value = 0;
...
TStar.Description = 'Maximum downpath distance of the aimpoint';
...
TStar.Description = 'Tangent of the maximum intercept angle';
...
TStar.Description = 'Distance from a waypoint where the vehicle is considered at that waypoint.';
