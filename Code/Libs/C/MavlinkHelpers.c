/**
 * This function implements all of the functions that are regularly in mavlink_helpers.h. It can be
 * compiled with the regular MAVLink includes by setting the build macro MAVLINK_SEPARATER_HELPERS.
 * This fixes runtime AddressErrors that I'm experiencing with MPLAB X 2.26/XC16 1.24.
 */
