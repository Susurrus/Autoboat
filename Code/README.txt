...
basic_model - Implements a crude inverse-bicycle model for the boat. Based mostly off of the wg1 code. Provides an estimate of energy usage and gain from solar panels. Includes autonomous waypoint controller from previous waypoint_control model.